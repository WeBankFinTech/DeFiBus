...
package com.webank.defibus.consumer;
...
public abstract class DeFiBusMessageListenerConcurrentlyOnce implements MessageListenerConcurrently {
    private static final Logger LOG = LoggerFactory.getLogger(DeFiBusMessageListenerConcurrentlyOnce.class);
    ...
    public abstract ConsumeConcurrentlyStatus handleMessage(MessageExt msg, ConsumeConcurrentlyContext context);
