...
public class DeFiBusClientHookFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(DeFiBusClientHookFactory.class);

    public static RPCHook createRPCHook(final RPCHook rpcHook) {
        return new RPCHook() {
            @Override
